...
mongoose.connect('mongodb+srv://root:root@mycluster.ai1mm.mongodb.net/ListOfStudents?retryWrites=true&w=majority').then(()=>console.log("Connected to Database"))
app.use(express.json())
app.post("/add-new-post",async(req,res)=>{
     const myname = req.body.Name;
     const myregno = req.body.reqno;
